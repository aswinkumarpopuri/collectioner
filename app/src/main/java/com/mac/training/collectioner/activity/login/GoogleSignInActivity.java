...
import static com.mac.training.collectioner.R.string.*;

public class GoogleSignInActivity extends BaseProgressActivity implements View.OnClickListener,GoogleApiClient.OnConnectionFailedListener {
    ...
    private void updateUI(FirebaseUser user) {
        hideProgressDialog();
        if (user != null) {
            mStatusTextView.setText(getString(google_status_fmt, user.getEmail()));
